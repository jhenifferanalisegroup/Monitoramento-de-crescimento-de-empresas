...
def buscar_primeiro_snapshot(cnpj):
    ...
    query = text("""
        SELECT cnpj_empresa, total_saida, data_snapshot
        FROM gestfiscal_snapshotsaidas
    ...
    return {
        ...
        "total_saida": result.total_saida,
...
def salvar_snapshot(cnpj, total_saida):
    """
    ...
    insert_query = text("""
        INSERT INTO gestfiscal_snapshotsaidas (cnpj_empresa, total_saida, data_snapshot)
        VALUES (:cnpj_empresa, :total_saida, :data_snapshot)
    """)
