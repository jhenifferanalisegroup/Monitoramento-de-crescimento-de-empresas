...
def montar_email(alertas):
    ...
    for a in alertas:
        linha = f"""
                    <tr>
                        <!--<td style="padding:6px 4px; word-break:break-word;">{a['tipo']}</td>-->
                        ...
                        <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff; border-radius:8px; overflow:hidden; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; color:#000000;">
                            ...
                            <tr>
                                <td style="padding:24px;">
                                    <h1 style="margin:0 0 8px 0; font-size:22px; color:#000000;">Alerta de crescimento de empregados</h1>
                                    <p style="margin:0 0 16px 0; font-size:14px; color:#333333;">
                                        As empresas abaixo apresentaram crescimento de empregados acima de 20% em pelo menos um dos cenários monitorados.
                                    </p>
                                    <table width="100%" cellpadding="4" cellspacing="0" style="border-collapse:separate; border-spacing:0; font-size:12px;">
                                        ...
                                        <thead>
                                            <tr style="background-color:#D1B48B; color:#000000;">
                                                ...
                                                <th align="right" style="padding:8px;">Empregados (anterior)</th>
                                                <th align="right" style="padding:8px;">Empregados (Atual)</th>
                            ...
                            <tr>
                                <td style="background-color:#faf4ea; padding:12px 24px; font-size:11px; color:#555555;" align="right">
                                    Monitoramento automático de evolução de empregados
                                </td>
                            </tr>
                        </table>
                    </td>
...
def enviar_email_alerta(html):
    ...
    params: resend.Emails.SendParams ={
        "from":f"Alerta de Crescimento de Empregados - Análise Group <ti@gesthub.analisegroup.cnt.br>",
        "to":["jheniffer@analisegroup.cnt.br", "jonathan.viana@analisegroup.cnt.br"],
        "subject":"Crescimento de empregados detectado",
        "html": html
    }
